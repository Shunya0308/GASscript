...
var TRELLO_KEY = PropertiesService.getScriptProperties().getProperty("trelloKey");
var TRELLO_TOKEN = PropertiesService.getScriptProperties().getProperty("trelloToken");
...
function logging(str) {
  var sheet = SpreadsheetApp.openById(TRIGGER_SETTIME_SHEET_ID).getActiveSheet();
...
function getTask() {
  var url = "https://trello.com/1/lists/" + LIST_ID + "/cards?key=" + TRELLO_KEY + "&token=" + TRELLO_TOKEN;
